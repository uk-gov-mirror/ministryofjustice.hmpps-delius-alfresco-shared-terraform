# DISABLED WILL BE REVISITED AFTER SOLR CONFIG UPDATE
# module "db" {
...
#   snapshot_identifier    = "arn:aws:rds:eu-west-2:563502482979:snapshot:alf-aurora-restore" #var.alf_snapshot_identifier
#   vpc_id                 = local.vpc_id
